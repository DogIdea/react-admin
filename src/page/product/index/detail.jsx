        ...
        <div id="page-wrapper">
            ...
            <div className="form-horizontal">
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-3">
                        <div className="input-group">
                            <input type="number" className="form-control" value={this.state.price} readOnly></input>
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-3">
                        <div className="input-group">
                            <input type="number" className="form-control" placeholder="库存" value={this.state.stock} readOnly></input>
